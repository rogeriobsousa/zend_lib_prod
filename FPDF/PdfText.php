<?php
/**
* @package Beneficio* @Copyright Copyright � 2006, Minist�rio do Desenvolvimento, Ind�stria e Com�rcio Exterior
* @author Minist�rio do Desenvolvimento, Ind�stria e Com�rcio Exterior. 
* Projeto: SISREFI - Sistema de Remessa Financeira
* Especifica��o: Especifica��o de Artefato - Data; 05/01/2007  Vers�o: 1.0 N�mero:ESP000
* Analista respons�vel: Rilmer Silva Siqueira
* Desenvolvedor: Rilmer Silva Siqueira 
* @author rilmers
* @since 05/01/2007
* @date  05/01/2007
*/
include_once 'McTable.php';

class PdfText extends McTable 
{
    // ################################# Initialization

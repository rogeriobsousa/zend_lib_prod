    ...
    implements Zend_InfoCard_Xml_Assertion_Interface
{
     ...
     */
    const CONFIRMATION_BEARER = 'urn:coata:names:tc:SAML:1.0:cm:bearer';
    ...
    public function getConditions()
    {
        ...
        foreach($conditions->children('urn:coata:names:tc:SAML:1.0:assertion') as $key => $value) {
            switch($key) {
                case self::CONDITION_AUDIENCE:
                    foreach($value->children('urn:coata:names:tc:SAML:1.0:assertion') as $audience_key => $audience_value) {
    ...
    public function getAttributes()
    {
        ...
        foreach($attributes as $key => $value) {
            ...
            list($aValue) = $value->children('urn:coata:names:tc:SAML:1.0:assertion');
